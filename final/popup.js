...
submitBtn.onclick = function (event) {
  ...
  if (ansIsCorrect) {
    ...
    if (indexOfCurrentQuestion !== QUESTIONS.length - 1) {
      ...
      // disable
    var sorryMessage = document.getElementById('question');
    sorryMessage.textContent = "Okay, even though you got everything wrong, we shall give it to you out of pity :)"
    var answerForm = document.getElementById('answer-input');
    var submitting = document.getElementById('submit-btn');
